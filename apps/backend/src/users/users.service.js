...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.create = function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, bcrypt.hash(input.password, 12)];
                        case 1:
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.user.findMany({
                            ...
                            select: __assign(__assign({}, this.safeSelect()), { _count: { select: { instances: true } } }),
                        })];
                });
            });
        };
        ...
        UsersService_1.prototype.resetPassword = function (id, newPassword) {
            return __awaiter(this, void 0, void 0, function () {
                var passwordHash;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.prisma.user.update({
                                    where: { id: id },
                                    data: { passwordHash: passwordHash, mustChangePassword: true },
                                    select: this.safeSelect(),
                                })];
                    }
                });
        ...
        UsersService_1.prototype.safeSelect = function () {
            return {
                id: true,
                name: true,
                email: true,

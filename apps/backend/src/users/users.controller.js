...
var UsersController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(client_1.UserRole.ADMIN), (0, common_1.Controller)('users')];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        function UsersController_1(users, audit) {
        ...
        UsersController_1.prototype.get = function (id) {
            return this.users.getById(id);
        };
        UsersController_1.prototype.create = function (req, dto) {
        ...
        UsersController_1.prototype.update = function (req, id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var updated, actor;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        UsersController_1.prototype.updateStatus = function (req, id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var updated, actor;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.users.update(id, { status: dto.status })];
                        case 1:
                            updated = _a.sent();
                            actor = req.user;
                            return [4 /*yield*/, this.audit.log({
        ...
        UsersController_1.prototype.resetPassword = function (req, id, body) {
            return __awaiter(this, void 0, void 0, function () {

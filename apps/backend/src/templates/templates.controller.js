...
var TemplatesController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Controller)('templates')];
    ...
    var TemplatesController = _classThis = /** @class */ (function () {
        function TemplatesController_1(templates, audit) {
            this.templates = (__runInitializers(this, _instanceExtraInitializers), templates);
            this.audit = audit;
        }
        TemplatesController_1.prototype.list = function (user) {
            return this.templates.list(user);
        };
        TemplatesController_1.prototype.get = function (user, id) {
            return this.templates.get(user, id);
        };
        TemplatesController_1.prototype.create = function (req, user, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var tpl;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.templates.create(user, dto)];
                        case 1:
                            tpl = _a.sent();
        ...
        TemplatesController_1.prototype.update = function (req, user, id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var tpl;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.templates.update(user, id, dto)];
                        case 1:
                            tpl = _a.sent();
                            return [4 /*yield*/, this.audit.log({
                                    userId: user.sub,
        ...
        TemplatesController_1.prototype.remove = function (req, user, id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.audit.log({
                                userId: user.sub,
                        ...
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this.templates.remove(user, id)];
                    }
                });
            });
        };

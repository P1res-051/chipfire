...
var SettingsController = function () {
    var _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(client_1.UserRole.ADMIN), (0, common_1.Controller)('settings')];
    ...
    var SettingsController = _classThis = /** @class */ (function () {
        function SettingsController_1(settings, audit) {
            this.settings = (__runInitializers(this, _instanceExtraInitializers), settings);
            this.audit = audit;
        }
        SettingsController_1.prototype.get = function () {
            return this.settings.get();
        };
        SettingsController_1.prototype.update = function (req, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var updated, actor;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.settings.update(dto)];
                        case 1:
                            updated = _a.sent();
                            actor = req.user;
    ...
    (function () {
        ...
        _update_decorators = [(0, common_1.Patch)()];
